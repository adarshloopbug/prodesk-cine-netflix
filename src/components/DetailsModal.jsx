  ...
  return (
    ...
    >
      <div className="modal-content details-modal-box">
        <button className="close-btn circle-close-btn" id="close-details-btn" onClick={onClose}>
          <i className="fa-solid fa-xmark"></i>
        </button>

        {isLoading && (
          <div className="modal-body" style={{ textAlign: 'center', padding: '100px 0' }}>
        ...
        {isError && (
          <div className="modal-body" style={{ padding: '60px 40px' }}>
            ...
            <p id="detail-overview" style={{ marginTop: '20px' }}>
              Please confirm your internet connection and API keys.
            </p>
          </div>
        )}
          ...
          <>
            ...
            <div className="details-body">
              ...
              <div className="details-meta-row">
                <span className="meta-item badge" id="detail-rating">
                  <i className="fa-solid fa-star"></i>{' '}
                  {details.vote_average ? details.vote_average.toFixed(1) : 'N/A'}
                </span>
                <span className="meta-item" id="detail-year">
                  {details.release_date ? details.release_date.split('-')[0] : 'N/A'}
                </span>
                <span className="meta-item" id="detail-runtime">
                  {details.runtime ? `${details.runtime} min` : 'N/A'}
                </span>
                <button
                  className={`fav-action-btn ${isFavorite ? 'liked' : ''}`}
                  id="detail-fav-toggle"
              ...
              <div className="details-genres" id="details-genres">
